...
namespace Lion.CodeGenerator.Migrations
{
    ...
    [Migration("20220227064621_AggregateModels")]
    partial class AggregateModels
    {
            ...
            modelBuilder.Entity("Lion.CodeGenerator.AggregateModels.Aggregates.AggregateModel", b =>
                {
                    ...
                    b.HasKey("TenantId", "BusinessLineId", "BusinessProjectId", "Code");
            ...
            modelBuilder.Entity("Lion.CodeGenerator.AggregateModels.Aggregates.EntityModel", b =>
                {
                    ...
                    b.Property<Guid>("AggregateModelBusinessLineId")
                        .HasColumnType("char(36)");

                    b.Property<Guid>("AggregateModelBusinessProjectId")
                        .HasColumnType("char(36)");

                    b.Property<string>("AggregateModelCode")
                        .IsRequired()
                        .HasColumnType("varchar(255)");
                    ...
                    b.HasIndex("AggregateModelTenantId", "AggregateModelBusinessLineId", "AggregateModelBusinessProjectId", "AggregateModelCode");
            ...
            modelBuilder.Entity("Lion.CodeGenerator.AggregateModels.Aggregates.PropertyModel", b =>
                {
                    ...
                    b.Property<Guid?>("EntityModelAggregateModelId")
                        .HasColumnType("char(36)");

                    b.Property<string>("EntityModelCode")
                        .HasColumnType("varchar(255)");
                    ...
                    b.HasIndex("EntityModelAggregateModelId", "EntityModelCode");

                    b.HasIndex("AggregateModelTenantId", "AggregateModelBusinessLineId", "AggregateModelBusinessProjectId", "AggregateModelCode");

                    b.ToTable("Gen_PropertyModel", (string)null);
                });
