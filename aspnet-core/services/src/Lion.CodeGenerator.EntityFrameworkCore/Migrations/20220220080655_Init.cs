    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Gen_BusinessLine", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Gen_BusinessProject", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Gen_BusinessProject_Gen_BusinessLine_BusinessLineId",
                        column: x => x.BusinessLineId,
                        principalTable: "Gen_BusinessLine",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Gen_BusinessLine_TenantId_Id",
                table: "Gen_BusinessLine",
                columns: new[] { "TenantId", "Id" });

            migrationBuilder.CreateIndex(
                name: "IX_Gen_BusinessProject_BusinessLineId",
                table: "Gen_BusinessProject",
