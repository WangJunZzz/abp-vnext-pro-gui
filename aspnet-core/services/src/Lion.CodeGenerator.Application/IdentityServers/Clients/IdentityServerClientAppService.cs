...
namespace Lion.CodeGenerator.IdentityServers.Clients
{
    [Authorize(Policy = CodeGeneratorPermissions.IdentityServer.Client.Default)]
    public class IdentityServerClientAppService : CodeGeneratorAppService, IIdentityServerClientAppService
    {
        ...
        /// <returns></returns>
        [Authorize(Policy = CodeGeneratorPermissions.IdentityServer.Client.Create)]
        ...
        /// </summary>
        /// <returns></returns>
        [Authorize(Policy = CodeGeneratorPermissions.IdentityServer.Client.Delete)]
        ...
        /// </summary>
        /// <returns></returns>
        [Authorize(Policy = CodeGeneratorPermissions.IdentityServer.Client.Update)]
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [Authorize(Policy = CodeGeneratorPermissions.IdentityServer.Client.Enable)]
