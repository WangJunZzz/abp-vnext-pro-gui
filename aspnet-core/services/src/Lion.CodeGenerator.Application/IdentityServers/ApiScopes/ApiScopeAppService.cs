...
{
    [Authorize(Policy = CodeGeneratorPermissions.IdentityServer.ApiScope.Default)]
    public class ApiScopeAppService : CodeGeneratorAppService, IApiScopeAppService
    {
        ...
        [Authorize(Policy = CodeGeneratorPermissions.IdentityServer.ApiScope.Create)]
        ...
        [Authorize(Policy = CodeGeneratorPermissions.IdentityServer.ApiScope.Update)]
        ...
        [Authorize(Policy = CodeGeneratorPermissions.IdentityServer.ApiScope.Delete)]
