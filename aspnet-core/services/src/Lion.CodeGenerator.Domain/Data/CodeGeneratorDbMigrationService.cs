...
{
    public class CodeGeneratorDbMigrationService : ITransientDependency
    {
        public ILogger<CodeGeneratorDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<ICodeGeneratorDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public CodeGeneratorDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<ICodeGeneratorDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<CodeGeneratorDbMigrationService>.Instance;
        }
