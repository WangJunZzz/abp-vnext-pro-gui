...
namespace Lion.CodeGenerator
{
    ...
    public class CodeGeneratorIdentityServerModule : AbpModule
    {
        ...
        {
            Configure<AbpDistributedCacheOptions>(options => { options.KeyPrefix = "CodeGenerator:"; });
            var configuration = context.Services.GetConfiguration();
        ...
        {
            Configure<AbpVirtualFileSystemOptions>(options => { options.FileSets.AddEmbedded<CodeGeneratorIdentityServerModule>(); });
